import {
  ...
  export default function EditProduct() {
    ...
    const [formData, setFormData] = useState({
      ...
      production: "", // New production field
      quality: "a", // New quality field
      ud_field: "", // New UD field
      return_policy: "", // New return policy field
      discount_price: "", // New discount price field
    });
      ...
      const loadProduct = async () => {
        try {
          ...
          setFormData({
            ...
            production: product.production || "", // Set production if available
            quality: product.quality || "a", // Set quality if available
            ud_field: product.ud_field || "", // Set ud_field if available
            return_policy: product.return_policy || "", // Set return_policy if available
            discount_price: product.discount_price || "", // Set discount_price if available
          });
        } catch (error) {
          setSnackbar({
            open: true,
