...
import useUserStore from "../../store/user/userStore"; // Assuming a user store to handle wholesaler data
...
export default function CreateWholesaler() {
  ...
  const { createUser } = useUserStore(); // Assuming addUser is the action to add a wholesaler
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: err.message || "Failed to create wholesaler",
        severity: "error",
      });
    }
  };
  ...
  return (
    <Container>
      <Box className="breadcrumb">
        <Breadcrumb
          routeSegments={[
            { name: "Wholesalers", path: "/features/user/view" },
            { name: "Create Wholesaler" },
          ]}
        />
      </Box>

      <SimpleCard title="Create Wholesaler">
