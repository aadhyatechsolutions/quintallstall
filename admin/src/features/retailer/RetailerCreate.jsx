import {
  ...
  import useUserStore from "../../store/user/userStore"; // Assuming a user store to handle retailer data
  ...
  export default function CreateRetailer() {
    ...
    const { createUser } = useUserStore(); // Assuming addUser is the action to add a retailer
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setSnackbar({
          open: true,
          message: err.message || "Failed to create retailer",
          severity: "error",
        });
      }
    };
    ...
    return (
      <Container>
        ...
        <SimpleCard title="Create Retailer">
