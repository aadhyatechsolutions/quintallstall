...
import WholeSalerKYCView from "../features/wholesaler/WholesalerKYCView";
...
import RetailerKYCView from "../features/retailer/RetailerKYCView";
...
import DeliveryKYCView from "../features/delivery/DeliveryKYCView";
...
import PurchasedCoinsView from "../features/coin/PurchasedCoinsView";
...
const routes = [
  ...
  { path: "/", element: <Navigate to="/dashboard/default" /> },
  {
    ...
    children: [
      ...
      { path: "/features/wholesaler/view/:id", element: <WholeSalerView />, },
      ...
      { path: "/wholesaler/wholesaler-kyc/view/:id", element: <WholeSalerKYCView /> },

      { path: "/features/retailer/create", element: <RetailerCreate /> },
      { path: "/features/retailer/list", element: <RetailerList /> },
      { path: "/features/retailer/view/:id", element: <RetailerView /> },
      ...
      { path: "/commissions/vehicle-commission/view/:id", element: <VehicleCommissionView />, },
      ...
      { path: "/frontend/blog-category/view/:id", element: <BlogCategoryView />, },
      ...
      { path: "/frontend/special-offer/view/:id", element: <SpecialOfferView />, },
      ...
      { path: "/settings/coin-settings/view/:id", element: <CoinView />, },
      ...
      { path: "/settings/purchased-coins/view/:id", element: <PurchasedCoinsView /> },
      ...
      { path: "/settings/role/view/:id", element: <RoleView /> },
      ...
      { path: "/settings/staff/view/:id", element: <StaffView /> },
